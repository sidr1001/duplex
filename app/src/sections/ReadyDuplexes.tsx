      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-dark mb-4">
            Готовые дуплексы — <span className="text-green">зaезжайте и живите!</span>
          </h2>
          <p className="text-dark-light text-lg max-w-2xl mx-auto">
            Полностью готовые к проживанию дома с отделкой и коммуникациями
          </p>
        </motion.div>
        ...
        >
          {duplexes.map((duplex) => (
            <motion.div
              ...
              className="bg-white rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover transition-shadow duration-300 border border-gray-100"
            >
              {/* Image */}
              <div className="relative h-56 md:h-64 overflow-hidden">
                ...
                />
                <Badge className="absolute top-4 left-4 bg-green text-white border-0">
                  {duplex.status}
                </Badge>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-4 mb-4 text-dark-light text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{duplex.bedrooms} спальни</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <Bath className="w-4 h-4" />
                    <span>{duplex.bathrooms} санузла</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {duplex.features.map((feature, idx) => (
                    <span
                      key={idx}
                      className="text-xs bg-gray-100 text-dark-light px-3 py-1 rounded-full"
                    >
                      {feature}
                    </span>
                  ))}
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button className="w-full bg-turquoise hover:bg-turquoise-dark text-white font-semibold rounded-xl">
                      Смотреть планировку
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="max-w-3xl">
                    <DialogHeader>
                      <DialogTitle className="text-2xl">{duplex.name} — Планировка</DialogTitle>
                    </DialogHeader>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-gradient-to-br from-orange/10 to-turquoise/10 rounded-3xl p-8 md:p-12"
        >
          <div className="max-w-xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-dark mb-4">
              Не подошел ни один вариант?
            </h3>
            <p className="text-dark-light mb-6">
              Подберем индивидуальный проект под ваши потребности и бюджет
            </p>
            <LeadForm
              title=""
              buttonText="Подобрать дуплекс"
              fields={['name', 'phone']}
              variant="light"
            />
          </div>
